...
const deleteTask=(e,index)=>{
  setAllTasks([...allTasks.slice(0,index), ...allTasks.slice(index+1)]);// or use ---> const filterdtodos=todos.filter((todo,i)=>{
};
...
return task; //it is very improtant to return the task that the user checked/ completed it
  });
